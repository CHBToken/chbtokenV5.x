...
#if defined(NDEBUG)
# error "CHBToken cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CHBToken Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        ...
        {
            nSubsidy = 2500000 * COIN; //  2.50M COINs for the SWAP
        } else {
            nSubsidy = 0;
        }
...
#ifdef ENABLE_WALLET
// CHBToken: attempt to generate suitable proof-of-stake
